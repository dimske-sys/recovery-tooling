#!/bin/bash
#Generated on 2023-03-04 16:31:24 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=2c34b461-1255-485f-8845-420f1e8ba2e3&pack=en-us&edition=core;coren;professional;professionaln;ppipro&aria2=2"
if [ $? != 0 ]; then
...
if [ -e ./files/convert.sh ]; then
  ...
  ./files/convert.sh esd "$destDir" 1
fi
